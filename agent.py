...
class Agent:
    ...
    def remember(self, state, action, reward, next_state, done):
        self.memory.append((state, action, reward, next_state, done)) # if it exceeds max memory, popleft()
    ...
    def train_long_memory(self):
        ...
        # bro if that is complicated this can also work
...
def train():
    ...
    while True:
        ...
        #perform move and the new state
